...
public:
	...
	//职工
	bool AddStaff(CString strName,CString strSex,CString strStaffID, CString idcard,CString strTel,int type,int sort,double fDaypay);
	bool ModifyStaff(CString strName,CString strSex,CString strStaffID,CString idcard,CString strTel,int type,int sort,double fDaypay);

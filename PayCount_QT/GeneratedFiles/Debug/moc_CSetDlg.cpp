...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CSetDlg_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CSetDlg_t qt_meta_stringdata_CSetDlg = {
    {
QT_MOC_LITERAL(0, 0, 7), // "CSetDlg"
QT_MOC_LITERAL(1, 8, 7), // "BtnSave"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 9) // "BtnCancel"

    },
    "CSetDlg\0BtnSave\0\0BtnCancel"
};
...
const QMetaObject CSetDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CSetDlg.data,
      qt_meta_data_CSetDlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CSetDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CSetDlg.stringdata))

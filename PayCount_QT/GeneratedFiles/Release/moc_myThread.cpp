...
QT_MOC_LITERAL(1, 9, 9), // "signUpPro"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 6) // "nValue"

    },
    "myThread\0signUpPro\0\0nValue"
};
...
void myThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signUpPro((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myThread::signUpPro)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myThread::signUpPro(int _t1)
{
